...
<!--       <el-button v-waves :loading="downloadLoading" class="filter-item" type="primary" icon="el-icon-download" @click="handleDownload">
    ...
    >
      ...
      <el-table-column min-width="300px" label="Town">
       <template slot-scope="scope">
          <span>{{scope.row.town }}</span>
        </template>
      </el-table-column>
      <el-table-column min-width="300px" label="City">
       <template slot-scope="scope">
          <span>{{scope.row.city }}</span>
        </template>
      </el-table-column>
      <el-table-column min-width="300px" label="State">
       <template slot-scope="scope">
          <span>{{scope.row.state }}</span>
        </template>
      </el-table-column>
      <el-table-column min-width="300px" label="Country">
       <template slot-scope="scope">
      ...
      <el-table-column align="center" label="Actions">
        <template slot-scope="scope">
          <router-link :to="'/leagues/edit/'+scope.row.id">
...
import { updateLeagueStatus } from '@/api/league';
