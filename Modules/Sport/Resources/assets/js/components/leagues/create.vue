  ...
  <div class="app-container">
   <el-form ref="postForm" :model="postForm" :rules="sportRules" label-width="120px">
    ...
    <el-form-item label="League Country" prop="country" >
	  ...
	  <el-form-item label="League Type" prop="league_type">
        <el-select v-model="postForm.league_type" placeholder="Please select a round">
      ...
      <el-form-item label="Round To Start" prop="round_to_start">
        <el-select v-model="postForm.round_to_start" placeholder="Please select a round">
  ...
  data() {
    ...
    return {
      ...
      sportRules: {
        ...
        round_to_start: [{ required: true, validator: validateName }],
        ...
        if (valid) {
          ...
          leagueResource
            .store(this.postForm)
              .then(response => {
                this.$message({
                  message: 'New League added successfully',
                  type: 'success',
                  duration: 5 * 1000,
                });
          });
